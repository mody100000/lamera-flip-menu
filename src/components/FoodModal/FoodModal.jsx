...
const EnhancedFoodModal = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 transition-opacity duration-300">
            <div className="bg-white rounded-2xl shadow-2xl w-[95%] max-w-4xl max-h-[90vh] overflow-hidden animate-in fade-in duration-300">
                {/* Header */}
                <div className="flex items-center justify-between bg-gradient-to-l from-gray-50 to-gray-100 p-6">
                    <button
                    ...
                    <h1 className="text-2xl font-semibold text-gray-800">التفاصيل</h1>
                </div>
                ...
                <div className="p-6 md:p-8 flex flex-col md:flex-row gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="relative group">
                            <img
                                src={foodImg}
                                alt="وجبة طعام"
                                className="w-full h-80 object-cover rounded-xl shadow-md group-hover:shadow-lg transition-all duration-300"
                            />
                    ...
                    <div className="w-full md:w-1/2 text-right space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <label className="font-semibold text-gray-800 text-lg">الكمية</label>
                        </div>
